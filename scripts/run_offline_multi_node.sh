...
echo $cmd
TP_VERBOSE_LOGGING=9 LOGLEVEL=DEBUG OMP_NUM_THREADS=8 LOCAL_RANK=0 LOCAL_WORLD_SIZE=1 RANK=$RANK WORLD_SIZE=2 MASTER_ADDR=$HOST_NODE_ADDR MASTER_PORT=$HOST_NODE_PORT exec $cmd
