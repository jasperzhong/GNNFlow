...
def train(train_loader, val_loader, sampler, model, optimizer, criterion,
    ...
    # multithread Queues
    sample_feature_queue = mp.Queue()
    feature_memory_queue = mp.Queue()
    memory_gnn_queue = mp.Queue()
    gnn_update_queue = mp.Queue()
    ...
    for e in range(args.epoch):
        ...
        # TODO: sampler is the main process
        sample(train_loader, sampler, sample_feature_queue)
