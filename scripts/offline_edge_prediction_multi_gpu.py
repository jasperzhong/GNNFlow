...
def main():
    ...
    logging.debug("initializing distributed training done")
    ...
    logging.debug("train_ds: {}".format(len(train_ds)))
    ...
    test_sampler = BatchSampler(
        ...
        batch_size=batch_size, drop_last=False)
    train_sampler = DistributedSampler(train_ds, shuffle=False, drop_last=False)

    logging.debug("train_sampler: {}".format(len(train_sampler)))
    ...
    logging.debug("num_nodes {}, num_edges {}".format(num_nodes, num_edges))
