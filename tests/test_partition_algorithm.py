...
from dgnn.distributed.partition_new import get_new_partitioner
import torch
import unittest
import time
import pandas as pd
...
class TestPartition(unittest.TestCase):
    ...
    def test_partition_graph(self):
        ...
        test_partitioner = get_new_partitioner(p_stgy, num_p)
        ...
        for i in range(0, len(dataset), ingestion_batch_size):
            ...
            print("Test Partition. Time usage: {} seconds; Speed: {} edges per sec\n"
                  .format(partition_end - partition_start,
                          ingestion_batch_size / (partition_end - partition_start)))
